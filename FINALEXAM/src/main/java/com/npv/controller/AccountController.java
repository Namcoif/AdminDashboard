...
import com.npv.dto.AccUpdateDTO;
...
//	@GetMapping(value="/{id}")
//	public AccountDTO getAccountInfoById(@PathVariable(name="id") int userId) {
//		System.out.println("userId: " + userId);
//		Account account = acService.getAccountInfoById(userId);
...
//	
	...
	public ResponseEntity<?> updateAccount(@PathVariable(name = "id") int id, @RequestBody AccUpdateDTO acDTO) {
		System.out.println("id: " + id);
		System.out.println(acDTO);
		
		BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
		String enCryptPassword = passwordEncoder.encode(acDTO.getPassword());
		acDTO.setPassword(enCryptPassword);
